...
lastTpt <- which(vaxx_plus_cases_fl$date == "2022-01-01")
...
```{r}
time_basis_full = bs(1:nrow(vaxx_plus_cases_fl), degree = 4)[rep(1:nrow(vaxx_plus_cases_fl), 1),]
...
sharedBasis_full <- bs(0:nrow(vaxx_plus_cases_fl), 
                       knots = seq(0, round_any(nrow(vaxx_plus_cases_fl), 50, f = ceiling) , by =115), 
                       degree = 4) 
