...
# alpha^inf ~ gamma(shape = 81.5249, rate = 18.4751) which maps probability of latent period shape being between 3.79 and 5.05
...
# beta^inf ~ gamma(shape = 94.06012, rate = 5.939876) which maps probability of latent period shape being between 13.78 and 17.96
