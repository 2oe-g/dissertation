...
# Coverage, width and bias for model 6 (latent and infectious period estimates)
...
# Coverage, width and bias for model 6 with weibull distribution (latent and infectious period estimates (scale and shape))
